...
public class JDEmailService implements EmailService {

  private static final Logger logger = LoggerFactory.getLogger(JDEmailService.class);
  ...
  @Autowired
  private JDEmailRequestBuilder emailRequestBuilder;
  @Autowired
