...
public interface NamespaceRepository extends PagingAndSortingRepository<Namespace, Long> {
  ...
  @Query(value = "SELECT * from namespacelock l,namespace n where n.Id=l.NamespaceId and n.AppId=:appId and n.ClusterName=:clusterName and l.IsDeleted=0", nativeQuery = true)
  List<Namespace> findWaitforRelease(@Param("appId") String appId, @Param("clusterName") String clusterName);
